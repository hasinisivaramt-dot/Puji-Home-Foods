  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5ECD7', padding: '80px 0 0' }}>
      <div style={{ maxWidth: '1250px', margin: '0 auto', background: '#fff', borderRadius: '0', boxShadow: '0 8px 30px rgba(0,0,0,.08)', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: '0', alignItems: 'stretch', minHeight: 'calc(100vh - 80px)' }}>

          {/* ── Sidebar ── */}
          <div style={{ background: 'linear-gradient(180deg,#220000,#4d0000)', color: '#fff', padding: '20px', borderRight: '1px solid rgba(255,255,255,.08)', display: 'flex', flexDirection: 'column', minHeight: '100%' }}>
          ...
          <div style={{ padding: '20px', background: '#fff' }}>
            <div style={{ marginBottom: '25px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '14px', marginTop: '20px', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '25px', marginTop: '20px' }}>
              ...
              {/* Recent Orders */}
              <div style={{ borderRadius: '18px', padding: '20px', border: '1px solid #ececec' }}>
                ...
                {orders.length === 0 ? (
                  <div style={{ textAlign: 'center', padding: '40px 0', color: '#9a6040' }}>
...
>
  Cancel Order
              ...
              <div>
                {/* Profile card */}
                <div style={{ background: 'white', borderRadius: '16px', padding: '25px', boxShadow: '0 5px 20px rgba(0,0,0,.08)', marginBottom: '20px' }}>
                  ...
                  <div style={{ width: '55px', height: '55px', fontSize: '22px', borderRadius: '50%', background: C.crimson, color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '20px' }}>
                    {initial}
                  </div>
                ...
                {/* Quick Actions */}
                <div style={{ background: 'white', borderRadius: '16px', padding: '25px', boxShadow: '0 5px 20px rgba(0,0,0,.08)' }}>
                  ...
                  {[
                    ...
                    <div key={i}>
                      <div onClick={() => setPage(a.page)} style={{ padding: '12px 0', cursor: 'pointer', color: '#333', fontWeight: 500 }}>
                        {a.icon} {a.label}
                      </div>
...
function DashboardCard({ icon, title, value, subtitle, onClick }) {
  return (
    <div onClick={onClick} style={{ cursor: 'pointer', background: '#fff', border: '1px solid #eee', borderRadius: '16px', padding: '14px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '15px' }}>
        <div style={{ width: '38px', height: '38px', borderRadius: '12px', background: '#FFF6E5', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }}>{icon}</div>
        <p style={{ margin: 0, fontSize: '15px', fontWeight: '600', color: '#333' }}>{title}</p>
      </div>
      <h2 style={{ fontSize: '24px', margin: '0 0 8px', color: '#111' }}>{value}</h2>
      <p style={{ color: '#8B1A1A', fontSize: '12px', margin: 0 }}>{subtitle}</p>
    </div>
  )
}
