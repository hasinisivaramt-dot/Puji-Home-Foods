...
export default function AProducts() {
  ...
  Promise.all([
    ...
    fetch("https://puji-home-foods-backend.onrender.com/api/categories")
      .then(r => r.json())
  ])
  ...
  const columns = [
    {
      ...
      render: (v) => (
        <img
          src={v?.startsWith('http') ? v : `https://puji-home-foods-backend.onrender.com/images/${v?.split('/images/')[1] || v || ''}`}
          alt=""
