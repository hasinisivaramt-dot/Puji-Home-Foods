...
const HERO_SLIDES = [
  ...
  pos: window.innerWidth < 768 ? 'center center' : 'center 35%',
  size: 'cover'
},
...
function MobileProfileMenu({ setPage }) {
...
const { totalItems } = useCart()
  ...
  style={{
    ...
    padding: window.innerWidth < 768 ? '0 10px' : '0 2rem', height: scrolled ? 64 : 72,
...
>
        ...
        <button
          onClick={onCartClick}
          style={{ position: 'relative', background: 'rgba(255,255,255,.07)', border: '1px solid rgba(201,168,76,.22)', borderRadius: '50%', width: window.innerWidth < 768 ? 34 : 38,
height: window.innerWidth < 768 ? 34 : 38, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: C.cream, transition: 'all .3s' }}
  ...
  <MobileProfileMenu setPage={setPage} />
) : (
...
function WishlistNavBtn({ setPage }) {
  ...
  return (
    <button
      ...
      title="My Wishlist"
      style={{ position: 'relative', background: count > 0 ? 'rgba(231,76,60,.15)' : 'rgba(255,255,255,.07)', border: `1px solid ${count > 0 ? 'rgba(231,76,60,.5)' : 'rgba(201,168,76,.22)'}`, borderRadius: '50%', width: window.innerWidth < 768 ? 34 : 38,
height: window.innerWidth < 768 ? 34 : 38, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: count > 0 ? '#e74c3c' : '#d4a0a0', fontSize: 18, transition: 'all .3s' }}
