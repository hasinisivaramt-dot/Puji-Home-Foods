    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{
          ...
          background: 'rgba(26,4,0,.98)', border: '1px solid rgba(201,168,76,.22)',
          borderRadius: 14, padding: 8, minWidth: 210,
          backdropFilter: 'blur(20px)', boxShadow: '0 20px 60px rgba(0,0,0,.6)',
          zIndex: 100, animation: 'fadeUp .2s ease both',
        }}>
          {/* User info */}
          <div style={{ padding: '10px 12px 10px', borderBottom: '1px solid rgba(201,168,76,.15)', marginBottom: 6 }}>
          ...
          {[
            ...
            <a key={item.label} href="#" style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '9px 12px', borderRadius: 8, textDecoration: 'none', color: C.cream, fontSize: '.8rem', transition: 'all .2s' }}
