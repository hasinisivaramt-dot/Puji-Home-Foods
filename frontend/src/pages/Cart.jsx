...
function EmptyCart({ onContinue }) {
  return (
    <div style={{ textAlign: 'center', padding: '4rem 2rem', background: 'white', borderRadius: 20, border: '1px solid rgba(201,168,76,.15)', boxShadow: '0 4px 20px rgba(0,0,0,.06)' }}>
      ...
      <p style={{ color: '#9a6040', fontSize: '.9rem', marginBottom: '1.8rem' }}>Looks like you haven't added anything yet. Explore our delicious homemade range!</p>
      <button
        onClick={onContinue}
